...
public class PlayerControlView extends FrameLayout {
  ...
  @Nullable private final View exitButton;
  ...
  @Nullable private final TextView Title;
  @Nullable private final ImageButton lockButton;
  ...
  public PlayerControlView(
    ...
    lockButton =findViewById(R.id.lockOre);
    if(lockButton != null){
